...
export default function SauryaBIPVApp() {
  ...
  function handleSubmit(e) {
    ...
    setTimeout(() => {
      ...
      setResult({ potential, rooftop, facade, recommendation: "Consider BIPV on south and west-facing facades; prioritize flat rooftops." });
      setRunning(false);
    }, 800);
  }
  ...
  return (
    <>
      ...
      <div className="container">
            ...
            <div className="viewer-grid">
              <div className="viewer-box" id="viewer">
                <div>
                  3D Model Viewer
                  <br />
                  <small>(Place Cesium/Three.js canvas here)</small>
                </div>
              </div>
              ...
              <div className="summary-box">
                ...
                <div>
                  {result && result.error ? (
                    ...
                    <div id="summary">Run a simulation to see results here.</div>
                  )}
                </div>
              </div>
            </div>
        ...
        <footer>Prototype • Built for Saurya Sankulan Mini Project</footer>
      </div>
    </>
  );
}